                ...
                <div class="panel-content">
                    <div class="panel-content">
                        <div class="form-group">
                            <?php if (isset($_SESSION) && ($_SESSION['no_user'])) { ?>
                                <div class="alert alert-danger fade show" role="alert">
                                    <?php echo $_SESSION['no_user']; unset($_SESSION['no_user']); ?>
                                </div>
                            <?php } ?>

                            <?php if (isset($_SESSION) && ($_SESSION['no_password'])) { ?>
                                <div class="alert alert-danger fade show" role="alert">
                                    <?php echo $_SESSION['no_password']; unset($_SESSION['no_password']); ?>
                                </div>
                            <?php } ?>

                            <?php if (isset($_SESSION) && ($_SESSION['user'])) { ?>
                                <div class="alert alert-success fade show" role="alert">
                                    Здравстуйте, <?php echo $_SESSION['user']['email']; ?>
                                </div>
                            <?php } ?>
